...
public class KakaoAPI {
    ...
    try {
        ...
        sb.append("&client_id=adca34fb40e1d2e79631a91ac4c1b21f");
//        sb.append("&redirect_uri=http://localhost:82/login/kakao");
        sb.append("&redirect_uri=http://43.201.9.43/login/kakao");
