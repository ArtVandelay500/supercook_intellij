        ...
        <div class="mainBox">
            <div class="mainContainer">
                ...
                <div class="mainLabelBox">
                    <h2 class="tableLabel">재료코드 관리</h2>
                    <div class="addBox" onclick="location.href='/ingForm'">
                        <h3 class="tableSubLabel">재료코드 추가</h3>
...
<script type="text/javascript">
    ...
    goList = function(thisPage) {
        if(thisPage == 0) {
            ...
            $("form[name=search]").attr("action", "/ingList/list").submit();
